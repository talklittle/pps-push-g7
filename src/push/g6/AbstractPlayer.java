...
public abstract class AbstractPlayer extends Player {
    ...
    protected  HashMap<Point,Integer> piles=null;
    ...
    public HashMap<Point,Integer> getPiles() {
        return this.piles;
    }
    ...
    /**
     * Function returning to which player's territory
     * a coin belongs
     */
 ...
 public static boolean isWhite(Point p) {
    ...
    public ArrayList<Integer> updateScores() {
       ...
       piles=new HashMap<Point,Integer>();
        ...
        for (int j = 0; j < 9; j++) {
            ...
            for (int i = 0; i < curRowLen; i++) {
                ...
                if(cointNum!=0){
                    this.pileCnt++;
                    this.piles.put(new Point(i,j), cointNum);
                }
                Direction closest = null;
                int neighbour1 = 8;
                int neighbour2 = 8;
